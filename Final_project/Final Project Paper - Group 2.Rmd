...
modDum <- dummyVars(views ~ likes + dislikes + comments + tags + category +
                   ...
                   video_error_or_removed + lkratio,
...
The signs of these coefficients make sense in the main. Increased `likes`,
...
popular. Therefore we expected negative coefficients for other categories. We
were surprised that was not the case. The "worst" category predictor by
magnitude is the `Nonprofits & Activism`. The "best" is `Gaming`.
