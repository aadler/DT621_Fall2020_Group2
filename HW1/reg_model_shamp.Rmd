...
Three predictions are unreasonably large, but not bad given the metrics. Two predictions are above the MLB reccord, but only by two or three wins. With an RMSE of 9.53 and $R^{2}=0.446$, and $R^{2}_{ADJ} =0.43$ we have a model that explains 44% of the variance in the data and can predict wins within $\pm 10$ wins for a given season. That's pretty good at predicting wins relative to seasoned baseball veterans. 
