...
significance: `TEAM_BATTING_H`, `TEAM_PITCHING_H` and `TEAM_PITCHING_BB`. Additionally, 
we see that both `TEAM_BATTING_1B` and `AB` have no coefficients at all! This is likely 
due to the fact that they are colinear with other variables in the model. 
