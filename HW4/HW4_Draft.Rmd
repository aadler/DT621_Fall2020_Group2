...
are significant.  What this may be telling us is that a linear regression is
...
starting with the all the predictors. Experimentation with interactions only had
...
at even the 10% level. What this may be telling us is that a linear regression is
***not*** the proper model for this analysis, and the algorithm is struggling to
...
estimate severity and a hierarchial contingent stocahstic cash flow model would
