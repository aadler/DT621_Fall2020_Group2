...
trnXFDpp <- preProcess(trnXFD, method = c('nzv', 'knnImpute'), k = 5)
...
# preProcess with near-zero value and kNN imputation
trnXSDpp <- preProcess(trnXSD, method = c('nzv', 'knnImpute'), k = 5)
...
tstXSDpp <- preProcess(tstXSD, method = c('nzv', 'knnImpute'), k = 5)
