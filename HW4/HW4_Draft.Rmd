...
order would be: `URBANICITY.Urban`, `CAR_USECommercial:URBANICITYUrban`,
`REVOKED.Yes`, `TRAVTIME`, `CAR_TYPE.Sports Car`, `CLM_FREQ`, `TIF`, `MVR_PTS`,
`CAR_TYPE.SUV`, and `JOB.Blue Collar`.
...
`HOME_VAL`. Similarly for the inter
