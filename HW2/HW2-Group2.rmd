...
author: Avraham Adler, Samantha Deokinanan, Amber Ferger, John Kellogg, Bryan
  Persaud, Jeff Shamp
date: "10/11/2020"
output:
...
negative. The actual confusion matrix comprises the 4 cells containing `a`, `b`,
`c`, and `d`. The enhancements around the matrix display the definitions for
many common classification metrics.
