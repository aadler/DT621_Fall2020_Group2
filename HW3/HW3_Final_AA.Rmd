...
Lastly, while `rad.1` is the base case, `rad.2` has disappeared as well,
implying that `rad = 2` should be considered indistinguishable from `rad = 1`. 
```
                    Df Deviance    AIC
<none>                   90.565 122.56
+ dis                1   89.191 123.19
...
<!-- The blended model is comprised of two sub-models, the logistic and the SVM. -->
<!-- Below are the prediction results for each sub-model.  -->
...
<!-- We see that they are both in the low eighties percent for accuracy, and low -->
<!-- nineties for roc auc. Together make for a better overall prediction.  -->
