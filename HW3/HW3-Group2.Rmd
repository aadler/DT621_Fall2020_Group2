...
orthogonal polynoial regression, which is out of the scope of this class. Given
...
# Model 1: Capture the indices for Model 3 then remove the uneeded column
tstIDX <- test_df$id
...
much. Therefore, intentional selection of pairs is required.
